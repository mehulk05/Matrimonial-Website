...
<button class="tablinks" onclick="openCity(event, 'Profile')">Profile Pic</button>
                    ...
                    <div class="tabcontent" id="edu">
                       <form method="POST" id="signup-form" class="signup-form" action="signUp_edu.php">
                        ...
                        <div class="row">
                         ...
                         <select class="form-control" id="hedu" name="hedu" required>
        ...
        <option value="Less than high school">Less than high school</option>
                           ...
                           <div class="col-xs-3 form-group">
                            ...
                            Education Field
                            <input type="text" class="form-input" name="edufd" id="edufd" placeholder="field" required/>
                        </div>
                            
                            <div class="col-xs-6 form-group">
                        
                            University of last Attended Course
                            <input type="text" class="form-input" name="uni" id="uni" placeholder="university" required/>
                        </div>
                           </div>
                           <div class ="row">
                            <div class="col-xs- 3 form-group">
                            ...
                            <input type="text" class="form-input" name="clg" id="clg" placeholder="college/school"/ required>
                        </div>
                            <div class="col-xs-3 form-group">
                            Your Work  
                         <select class="form-control" id="wk" name="wk" required>
        ...
        <option value="Not Working">Not Working</option>
                            ...
                            As
                            <input type="text" class="form-input" name="as" id="as" placeholder="employment type" required/>
                        </div>
                                <div class="col-xs-4 form-group">
                        Income
                       ...
                       <form method="POST" id="signup-form" class="signup-form" action="signUp_life.php">
                        ...
                        <h2 class="form-title">Lifestyle </h2> 
                           ...
                           <div class="row">
                            <div class="col-xs-3 form-group">
                            Diet 
                         <select class="form-control" id="dt" name="dt" required>
        ...
        <option value="Occasionaly">occassionaly</option>
                            ...
                            Mother Tounge
                            <input type="text" class="form-input" name="mt" id="mt" placeholder="eg. Gujarati"required/>
                               </div>
                           </div>
                           <div class="row">
                           <div class="col-xs-3 form-group">
        ...
        <option value="Others">Others</option>
                              ...
                              <div class="col-xs-3 form-group"> 
                               Number of Brothers 
                            <input type="number" class="form-input" name="brs" id="brs" placeholder="eg.0" required/>
                               </div>
                               <div class="col-xs-3 form-group">
                               Number of Sisters 
                            <input type="number" class="form-input" name="sis" id="sis" placeholder="eg.0" required/>
                           </div>
                           </div>
                             <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Save"  />
