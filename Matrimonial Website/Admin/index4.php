      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Current Users</li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="table-responsive">
                    ...
                    <form method="POST" id="signup-form" class="signup-form" action="event_upload.php" enctype="multipart/form-data" >
                             <input type="file" id="event_2" name="event_2"/><br><br>
 ...
 $conn= $conn=mysqli_connect("localhost","u757577044_root","r00000t","u757577044_wb");
    ...
    while($row=mysqli_fetch_array($result))
    {
                 ...
                 echo $row['id'];
                  ...
                  echo "</td> <td>";
                  echo "<form action= 'modify2.php'> <button name='btn1' id = 'btn1' type ='submit' value=' ". $row['id']. " ' > Delete </button> 
                  </form>";
                  echo "</tbody>";
