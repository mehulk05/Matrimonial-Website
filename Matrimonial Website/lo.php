...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
  <!-- 
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-10 text-right menu-1">
                        ...
                        <li class="active"><a href="lo.php">Log In</a></li>
                         <li><a href="gallery.php">Gallery</a></li>
                          <li><a href="add.php">Your Advertisement</a></li>
					</ul>
	...
	<div id="fh5co-couple" class="fh5co-section-gray">
		<div class="container">
			<?php include 'LogIn/us_logIn.html';?>
			<center>
			If you have not verified your documents, kindly visit<a href="contact.html"> contact us </a> section to find the address<br> where you could either post your documents or can visit the center. Once verified you <br> would receive an email with your log-in Id and Password.</center>
		</div>
	</div>
				...
				<div class="col-md-12 text-center">
					<p>
						...
						<small class="block">Designed by <a href="contact.html" target="_blank">Suhani</a> Chacha and <a href="contact.html" target="_blank">Mehul</a>  Kothari</small>
						 <h3>
	                       <small class="block"> Teamplate by  FREEHTML5.co</small>
	                   </h3>
					</p>
