...
<table width="498" border="0"  cellpadding="0" style="color: lightblue; ">
  ...
  <tr>
    ...
    <td valign="top"  style="color: yellow; "><b><?php echo $lname1 ?></td>
  </tr>
  <tr>
...
<button  type="button" id="formButton" style="width:75% ;color: darkblue;" ><h3 style="align:center;color: darkblue;"><b>Physical Qualities!</h3></button><br><br>
<div id="toggle" style="display:none">
<form id="form1" >
<table width="398" height="200" border="0" align="center" cellpadding="0" style="color: lightblue;">
  <tr>
    <td height="26" colspan="2"><h2 style="float:center;color: white;"><center>Physical Qualities</center></h2></center> </td>
  </tr>
  <tr>
...
<table width="398" height="200" border="0" align="center" cellpadding="0" style="color: lightblue;">
  <tr>
    <td height="28" colspan="2"><h2 style="float: center;color: white;"><center>Community</h2></center> </td>
  </tr>
  <tr>
    
    <td width="82" valign="top"><div align="left">Gotra:</div></td>
...
<table width="498" height="350" border="0" align="center" cellpadding="0" style="color: lightblue;">
  <tr>
    <td height="26" colspan="2"><h2 style="float: center;color: white;"><center>Education And Occupation</h2></center> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    <td valign="top"><div align="left">Income :</div></td>
...
<table width="498" height="300" border="0" align="center" cellpadding="0" style="color: lightblue;">
  <tr>
    <td align="center" height="26" colspan="2"><h2 style="float: center;color: white;"><center>Lifestyle </h2> </td>
  ...
  <tr>
    ...
    <td valign="top" style="color: yellow; "><b><?php echo $f_n ?></td>
  </tr>
  
  
 <tr>
    <td valign="top"><div align="left">Father's Profession  :</div></td>
    <td valign="top" style="color: yellow; "><b><?php echo $f_p ?></td>
  </tr>
  
  
  <tr>
    <td valign="top"><div align="left">Mother Name  :</div></td>
    <td valign="top" style="color: yellow; "><b><?php echo $m_n ?></td>
  </tr>
  
  
 <tr>
    <td valign="top"><div align="left">Mother's Profession  :</div></td>
    <td valign="top" style="color: yellow; "><b><?php echo $m_p ?></td>
  </tr>
   ...
   <tr>
    <td valign="top"><div align="left">Brothers Status :</div></td>
    <td valign="top" style="color: yellow; "><b><?php echo $bms ?></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td valign="top"><div align="left">Sister Status  :</div></td>
    <td valign="top" style="color: yellow; "><b><?php echo $sms ?></td>
  </tr>
