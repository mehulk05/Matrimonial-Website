            ...
            <div class="col-md-3">
                <div class="vertical-menu">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-input" name="fn" id="fn" placeholder="name"/>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-input" name="id" id="id" placeholder="Id"/>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-input" name="sub_com" id="sub_com" placeholder="community"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="selectdiv">
                            <select class="form-input" id="age" name="age" style="font-family: monospace;font-size: 22px; width:202px; height:42px; background-color:white;" >
                                <option value="0"> <div class="dot"></div> Age</option>
                                <option value="1"> <div class="dot"></div> 19-22</option>option>
                                <option value="2"> <div class="dot"></div> 22-25</option>
                                <option value="3"> <div class="dot"></div> 25-29</option>
                                <option value="4"> <div class="dot"></div> >29 </option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
