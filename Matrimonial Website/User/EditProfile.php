...
<body>
  ...
  <button class="tablinks" onclick="openCity(event, 'lifestyle')">Lifestyle and Family</button>
  <button class="tablinks" onclick="openCity(event, 'Profile')">Profile Pic</button>
</div>
                    
                    <div class="tabcontent" id="personal">
                    <form method="POST" id="signup-form" class="signup-form" action="../EditProfile/Edit_personal.php">
                      
                        <h2 class="form-title">Edit Personal Details</h2>
                          <div class="row">
                            <div class="col-xs-3 form-group">
                        
                            Your Name<br>
                            <input type="text" class="form-input" name="fn" id="fn" value="<?php echo $fname ?>" required/>
                        </div>
                        
                          
                            <div class="col-xs-3 form-group">
                            Your Surname
                            <input type="text" class="form-input" name="ln" id="ln" value="<?php echo $lname ?>" required/>
                        </div>

                         <div class="col-xs-3 form-group">
                            Your Address
                            <input type="text" class="form-input" name="ln" id="add" value="<?php echo $addr ?>" required/>
                        </div>
                              
                              <div class="col-xs-3 form-group">
                              Your Birth-date
                                  <input type="date" class="form-input" name="dob" id="dob" value="<?php echo $dob ?>" required />
                              </div>
                    ...
                    <form method="POST" id="signup-form" class="signup-form" action="../EditProfile/Edit_physicsl.php">
        ...
        <option value="dark"> <div class="dot"></div> Dark</option>
                    ...
                    <form method="POST" id="signup-form" class="signup-form" action="../EditProfile/Edit_community.php">
    ...
    <div class="tabcontent" id="edu">
        <form method="POST" id="signup-form" class="signup-form" action="../EditProfile/Edit_edu.php">
      ...
      <div class="tabcontent" id="lifestyle">
                       ...
                       <form method="POST" id="signup-form" class="signup-form" action="../EditProfile/Edit_life.php">
        ...
        <form method="POST" id="signup-form" class="signup-form" action="../EditProfile/UploadImage.php" enctype="multipart/form-data">
                          <div align="center">
